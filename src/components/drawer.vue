  ...
  <div>
    <div @click="toggleDrawerState">
      <svg
        ...
        xml:space="preserve"
        class="h-full w-8 p-1 mr-3 mt-1 fill-current text-gray-600 hover:text-gray-900"
      >
        <g>
          <g>
            <path
    ...
    <div class="fixed" v-show="drawerState">
      <div
        class="fixed top-0 right-0 h-full w-full bg-black opacity-50 overflow-auto ease-in-out transition-all duration-500 z-29 flex"
      ...
      <aside
        ...
        :class="drawerState ? '-translate-x-0' : 'translate-x-full'"
      >
        <button
